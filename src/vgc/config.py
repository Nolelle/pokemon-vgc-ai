...
# Open Team Sheets on the Bo1 ladder. Backed by the showdown repo's "champions" mod (see
# config/formats.ts in the showdown repo), NOT vanilla gen9 -- stat points, item legality,
